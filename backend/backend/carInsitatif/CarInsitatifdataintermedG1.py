...
class CarInsitatifdataintermedG1:
    ...
    def drop_table_if_exists(self) -> bool:
        ...
        try:
            ...
            cursor.execute("DROP TABLE IF EXISTS carInsitatifdataintermedG1")
    ...
    def create_table(self) -> bool:
        ...
        create_table_query = """
        CREATE TABLE carInsitatifdataintermedG1 (
            id_projet INTEGER,
        ...
        try:
            ...
            self.connection.commit()
            print("✅ Table 'carInsitatifdataintermedG1' créée avec succès!")
            return True
    ...
    def insert_data(self, data: Dict[str, Any]) -> Optional[int]:
        ...
        insert_query = """
        INSERT INTO carInsitatifdataintermedG1 (
    ...
    def get_all_data(self) -> List[Dict[str, Any]]:
        ...
        select_query = "SELECT * FROM carInsitatifdataintermedG1 ORDER BY household_id"
    ...
    def display_table_info(self) -> None:
        ...
        try:
            ...
            cursor.execute("SELECT COUNT(*) FROM carInsitatifdataintermedG1")
            count = cursor.fetchone()[0]
            
            print(f"\n📋 Informations de la table 'carInsitatifdataintermedG1':")
            print(f"   Nombre d'enregistrements: {count}")
            
            if count > 0:
                # Afficher les colonnes disponibles
                cursor.execute("PRAGMA table_info(carInsitatifdataintermedG1)")
                ...
                cursor.execute("SELECT * FROM carInsitatifdataintermedG1 LIMIT 3")
                rows = cursor.fetchall()
                columns = [description[0] for description in cursor.description]
    ...
    def clear_table(self) -> bool:
        ...
        try:
            self.connect()
            cursor = self.connection.cursor()
            cursor.execute("DELETE FROM carInsitatifdataintermedG1")
            self.connection.commit()
