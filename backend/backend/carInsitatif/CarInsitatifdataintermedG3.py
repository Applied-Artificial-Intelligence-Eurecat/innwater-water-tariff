...
class CarInsitatifdataintermedG3:
    ...
    def drop_table_if_exists(self) -> bool:
        ...
        try:
            ...
            cursor.execute("DROP TABLE IF EXISTS CarInsitatifdataintermedG3")
    ...
    def create_table(self) -> bool:
        ...
        create_table_query = """
        CREATE TABLE CarInsitatifdataintermedG3 (
            id_projet INTEGER,
        ...
        try:
            ...
            self.connection.commit()
            print("✅ Table 'CarInsitatifdataintermedG3' créée avec succès!")
            return True
    ...
    def insert_data(self, data: Dict[str, Any]) -> Optional[int]:
        ...
        insert_query = """
        INSERT INTO CarInsitatifdataintermedG3 (
    ...
    def get_all_data(self) -> List[Dict[str, Any]]:
        ...
        select_query = "SELECT * FROM CarInsitatifdataintermedG3 ORDER BY household_id"
    ...
    def display_table_info(self) -> None:
        ...
        try:
            ...
            cursor.execute("SELECT COUNT(*) FROM CarInsitatifdataintermedG3")
            count = cursor.fetchone()[0]
            
            print(f"\n📋 Informations de la table 'CarInsitatifdataintermedG3':")
            print(f"   Nombre d'enregistrements: {count}")
            
            if count > 0:
                # Afficher les colonnes disponibles
                cursor.execute("PRAGMA table_info(CarInsitatifdataintermedG3)")
                ...
                cursor.execute("SELECT * FROM CarInsitatifdataintermedG3 LIMIT 3")
                rows = cursor.fetchall()
                columns = [description[0] for description in cursor.description]
    ...
    def clear_table(self) -> bool:
        ...
        try:
            self.connect()
            cursor = self.connection.cursor()
            cursor.execute("DELETE FROM CarInsitatifdataintermedG3")
            self.connection.commit()
