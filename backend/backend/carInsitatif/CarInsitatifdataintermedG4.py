...
class CarInsitatifdataintermedG4:
    ...
    def drop_table_if_exists(self) -> bool:
        ...
        try:
            ...
            cursor.execute("DROP TABLE IF EXISTS CarInsitatifdataintermedG4")
    ...
    def create_table(self) -> bool:
        ...
        create_table_query = """
        CREATE TABLE CarInsitatifdataintermedG4 (
            id_projet INTEGER,
        ...
        try:
            ...
            self.connection.commit()
            print("✅ Table 'CarInsitatifdataintermedG4' créée avec succès!")
            return True
    ...
    def insert_data(self, data: Dict[str, Any]) -> Optional[int]:
        ...
        insert_query = """
        INSERT INTO CarInsitatifdataintermedG4 (
    ...
    def get_all_data(self) -> List[Dict[str, Any]]:
        ...
        select_query = "SELECT * FROM CarInsitatifdataintermedG4 ORDER BY household_id"
    ...
    def display_table_info(self) -> None:
        ...
        try:
            ...
            cursor.execute("SELECT COUNT(*) FROM CarInsitatifdataintermedG4")
            count = cursor.fetchone()[0]
            
            print(f"\n📋 Informations de la table 'CarInsitatifdataintermedG4':")
            print(f"   Nombre d'enregistrements: {count}")
            
            if count > 0:
                # Afficher les colonnes disponibles
                cursor.execute("PRAGMA table_info(CarInsitatifdataintermedG4)")
                ...
                cursor.execute("SELECT * FROM CarInsitatifdataintermedG4 LIMIT 3")
                rows = cursor.fetchall()
                columns = [description[0] for description in cursor.description]
    ...
    def clear_table(self) -> bool:
        ...
        try:
            self.connect()
            cursor = self.connection.cursor()
            cursor.execute("DELETE FROM CarInsitatifdataintermedG4")
            self.connection.commit()
