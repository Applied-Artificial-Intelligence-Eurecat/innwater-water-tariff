...
class ProjetDatabase:
    ...
    def drop_table_if_exists(self) -> bool:
        ...
        try:
            ...
            cursor.execute("DROP TABLE IF EXISTS carInsitatifdataintermed")
    ...
    def create_table(self) -> bool:
        ...
        create_table_query = """
        CREATE TABLE carInsitatifdataintermed (
            id_projet INTEGER,
        ...
        try:
            ...
            self.connection.commit()
            print("✅ Table 'carInsitatifdataintermed' créée avec succès!")
            return True
    ...
    def get_all_data(self) -> List[Dict[str, Any]]:
        ...
        select_query = "SELECT * FROM carInsitatifdataintermed ORDER BY household_id"
    ...
    def display_table_info(self) -> None:
        ...
        try:
            ...
            cursor.execute("SELECT COUNT(*) FROM carInsitatifdataintermed")
            count = cursor.fetchone()[0]
            
            print(f"\n📋 Informations de la table 'carInsitatifdataintermed':")
            print(f"   Nombre d'enregistrements: {count}")
            
            if count > 0:
                # Afficher les colonnes disponibles
                cursor.execute("PRAGMA table_info(carInsitatifdataintermed)")
                ...
                cursor.execute("SELECT * FROM carInsitatifdataintermed LIMIT 3")
                rows = cursor.fetchall()
                columns = [description[0] for description in cursor.description]
    ...
    def clear_table(self) -> bool:
        ...
        try:
            self.connect()
            cursor = self.connection.cursor()
            cursor.execute("DELETE FROM carInsitatifdataintermed")
            self.connection.commit()
