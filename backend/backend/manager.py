...
class ExcelFileReloader:
    ...
    def load_excel_file(self, file_path):
        """
        Charge le fichier data_La_Réunion_2.xls avec ajout automatique de id_projet
        """
        self.file_path = file_path
        ...
        try:
            ...
            # Ajouter la colonne id_projet avec valeur par défaut
    ...
    def _load_manually(self, file_path):
        """Charge le fichier manuellement avec xlrd et ajoute id_projet"""
        try:
            import xlrd
    ...
    def add_id_projet_to_dataframe(self):
        """Ajoute la colonne id_projet au DataFrame si elle n'existe pas"""
    ...
    def save_to_sqlite(self, table_name='reunion_data'):
        """Sauvegarde les données de La Réunion dans SQLite avec id_projet"""
        try:
    ...
    def export_to_csv(self, output_path='data_La_Réunion_2.csv'):
        """Exporte les données en CSV avec id_projet"""
        try:
