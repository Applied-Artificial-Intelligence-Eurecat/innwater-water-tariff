...
class CarIncitSplitG3:
    def __init__(self):
        ...
        self.table_cible = "CarInsitatifdataintermedG3"
    ...
    def execute_query(self) -> Optional[pd.DataFrame]:
        ...
        try:
            # Requête SQL corrigée pour utiliser la bonne table source
            query = f"""
            SELECT *
            FROM {self.table_source}
            WHERE is_poor_household = 1
            """
