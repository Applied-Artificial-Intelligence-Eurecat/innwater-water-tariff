...
class CarIncitSplitG5:
    def __init__(self):
        ...
        self.table_cible = "CarInsitatifdataintermedG5"
    ...
    def execute_query(self) -> Optional[pd.DataFrame]:
        ...
        try:
            ...
            # Si les colonnes requises n'existent pas, on peut essayer sans filtre
            if "no such column: is_connected_sewage" in str(e) or "no such column: is_poor_household" in str(e):
                print("ℹ️  Les colonnes de filtrage n'existent pas. Tentative de récupération de toutes les données...")
                try:
